...
public class ConviteUnidadeService {
    ...
    public ConviteUnidadeService(ConviteUnidadeRepository convites, UnidadeRepository unidades, UsuarioRepository usuarios, AssociacaoRepository associacoes) {
        this.convites = convites; this.unidades = unidades; this.usuarios = usuarios; this.associacoes = associacoes;
    }
    @Transactional
    public ConviteUnidadeResponseDTO criar(UUID unidadeId, Perfil perfil) {
        ...
        return ConviteUnidadeResponseDTO.de(convite, codigo);
    }
    @Transactional(readOnly = true)
    public List<ConviteUnidadeResponseDTO> listar(UUID unidadeId) { return convites.findAllByUnidadeIdOrderByExpiraEmDesc(unidadeId).stream().map(convite -> ConviteUnidadeResponseDTO.de(convite, null)).toList(); }
    @Transactional
